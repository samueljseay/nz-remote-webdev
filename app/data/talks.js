    ...
    talks: [
      {
        ...
        author: "Sam Seay",
        description:
          "What are service workers and how can we use them in our web developement?",
        links: [],
      },
      {
  ...
  "2020-04-09": {
    ...
    talks: [
      ...
      },
      {
        ...
        author: "Sam Seay",
        description:
          "Sam has recently taken on some entertaining problems with infinite scroll in React. He's going to chat about how he solved that using IntersectionObserver and other lessons he learned on the journey.",
        links: [
          "https://slides.com/samseay/deck-de526b",
          "https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API",
          "https://github.com/samueljseay/intersection-observer-examples",
          "https://codesandbox.io/s/o599joo75z",
          "https://twitter.com/samseay",
        ],
      },
    ],
  },
    ...
    talks: [
      {
        ...
        author: "Jeremy Wells",
        description:
          "Log files can be an invaluable source of information for developers to debug live production systems. Jeremy will show how his team has built a search solution on top of BigQuery and a migration to Athena. Pitfalls and pratfalls included.",
        links: [],
      },
      {
        ...
        description:
          "As a long time worker-from-home, Jonathan has been fascinated with how to get the most out of being distributed. This lockdown gave him a chance to test on a whole company.",
